...
class MainMenuState extends MusicBeatState
{
	...
	//var optionShit:Array<String> = ['story mode', 'freeplay', #if ACHIEVEMENTS_ALLOWED 'awards', #end 'credits', 'options'];
	...
	override function create()
	{
		...
		add(versionShit);*/
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Custom Songs / Mods Port v0.1.6 BUILD 12 BETA", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
